...
CFLAGS += -O3 -fomit-frame-pointer -funroll-loops -mavx2 -D NDEBUG
...
LFLAGS += `${PKG_TOOL} --libs alsa eigen3 sox fftw3 libpulse libpulse-simple`
...
CFLAGS += `${PKG_TOOL} --cflags alsa eigen3 sox fftw3 libpulse libpulse-simple`
