...
namespace dmxfish::filters::lua {
    ...
    sol::table mix_color_rgb_additive_cc(dmxfish::dmx::pixel c1, dmxfish::dmx::pixel c2) {
        ...
        return pixel2table(output);
    };

    sol::table mix_color_rgb_additive_ct(dmxfish::dmx::pixel c1, sol::table color2) {
        dmxfish::dmx::pixel c2 = dmxfish::dmx::pixel((double) color2["h"], (double) color2["s"], (double) color2["i"]);
        return mix_color_rgb_additive_cc(c1, c2);
    }

    sol::table mix_color_rgb_additive_tc(sol::table color1, dmxfish::dmx::pixel c2) {
        dmxfish::dmx::pixel c1 = dmxfish::dmx::pixel((double) color1["h"], (double) color1["s"], (double) color1["i"]);
        return mix_color_rgb_additive_cc(c1, c2);
    }

    sol::table mix_color_rgb_additive_tt(sol::table color1, sol::table color2) {
        dmxfish::dmx::pixel c1 = dmxfish::dmx::pixel((double) color1["h"], (double) color1["s"], (double) color1["i"]);
        dmxfish::dmx::pixel c2 = dmxfish::dmx::pixel((double) color2["h"], (double) color2["s"], (double) color2["i"]);
        return mix_color_rgb_additive_cc(c1, c2);
    }

    sol::table mix_color_rgb_normative_cc(dmxfish::dmx::pixel c1, dmxfish::dmx::pixel c2) {
        dmxfish::dmx::pixel output;
    ...
    sol::table mix_color_rgb_normative_ct(dmxfish::dmx::pixel c1, sol::table color2) {
        dmxfish::dmx::pixel c2 = dmxfish::dmx::pixel((double) color2["h"], (double) color2["s"], (double) color2["i"]);
        return mix_color_rgb_normative_cc(c1, c2);
    }

    sol::table mix_color_rgb_normative_tc(sol::table color1, dmxfish::dmx::pixel c2) {
        dmxfish::dmx::pixel c1 = dmxfish::dmx::pixel((double) color1["h"], (double) color1["s"], (double) color1["i"]);
        return mix_color_rgb_normative_cc(c1, c2);
    }

    sol::table mix_color_rgb_normative_tt(sol::table color1, sol::table color2) {
        dmxfish::dmx::pixel c1 = dmxfish::dmx::pixel((double) color1["h"], (double) color1["s"], (double) color1["i"]);
        dmxfish::dmx::pixel c2 = dmxfish::dmx::pixel((double) color2["h"], (double) color2["s"], (double) color2["i"]);
        return mix_color_rgb_normative_cc(c1, c2);
    }

    sol::table mix_color_hsi_ccb(dmxfish::dmx::pixel c1, dmxfish::dmx::pixel c2, bool reduce_saturation_on_far_angles) {
        dmxfish::dmx::pixel output;
    ...
    sol::table mix_color_hsi_ctb(dmxfish::dmx::pixel c1, sol::table color2, bool reduce_saturation_on_far_angles) {
        dmxfish::dmx::pixel c2 = dmxfish::dmx::pixel((double) color2["h"], (double) color2["s"], (double) color2["i"]);
        return mix_color_hsi_ccb(c1, c2, reduce_saturation_on_far_angles);
    }

    sol::table mix_color_hsi_tcb(sol::table color1, dmxfish::dmx::pixel c2, bool reduce_saturation_on_far_angles) {
        dmxfish::dmx::pixel c1 = dmxfish::dmx::pixel((double) color1["h"], (double) color1["s"], (double) color1["i"]);
        return mix_color_hsi_ccb(c1, c2, reduce_saturation_on_far_angles);
    }

    sol::table mix_color_hsi_ttb(sol::table color1, sol::table color2, bool reduce_saturation_on_far_angles) {
        dmxfish::dmx::pixel c1 = dmxfish::dmx::pixel((double) color1["h"], (double) color1["s"], (double) color1["i"]);
        dmxfish::dmx::pixel c2 = dmxfish::dmx::pixel((double) color2["h"], (double) color2["s"], (double) color2["i"]);
        return mix_color_hsi_ccb(c1, c2, reduce_saturation_on_far_angles);
    }

    sol::table mix_color_hsi_cc(dmxfish::dmx::pixel c1, dmxfish::dmx::pixel c2) {
        return mix_color_hsi_ccb(c1, c2, true);
    }

    sol::table mix_color_hsi_ct(dmxfish::dmx::pixel c1, sol::table color2) {
        return mix_color_hsi_ctb(c1, color2, true);
    }

    sol::table mix_color_hsi_tc(sol::table color1, dmxfish::dmx::pixel c2) {
        return mix_color_hsi_tcb(color1, c2, true);
    }

    sol::table mix_color_hsi_tt(sol::table color1, sol::table color2) {
    ...
    void init_lua_color_api(sol::state& lua) {
        ...
        // TODO add function mixing colors based on parameter indicating how much each color should contribute (hsi only)
    }
}